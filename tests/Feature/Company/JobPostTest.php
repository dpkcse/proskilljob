...
it('create a new job post', function () {
    ...
    $data = [
        'title' => 'Test title',
        'company_id' => 1,
        'job_start' => '2023-09-01', // test champ job_start
        'job_end' => '2023-09-30',   // test champ job_end
        'category_id' => 1,
        'role_id' => 1,
        'education_id' => 1,
        'experience_id' => 1,
...
it('update a job post', function () {
    ...
    $data = [
        'title' => 'Test title',
        'company_id' => 1,
        'job_start' => '2023-09-01', // test field job_start
        'job_end' => '2023-09-30',   // test field job_end
        'category_id' => 1,
        'role_id' => 1,
        'education_id' => 1,
        'experience_id' => 1,
