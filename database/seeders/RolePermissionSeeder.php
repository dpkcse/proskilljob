...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $roleModerator = Role::firstOrCreate(['name' => 'moderator', 'guard_name' => 'admin']);
        ...
        for ($i = 0; $i < count($permissions); $i++) {
            ...
            for ($j = 0; $j < count($permissions[$i]['permissions']); $j++) {
                ...
                if (str_ends_with($permission->name, '.view') || $permission->name === 'activity-log.view') {
                    $roleModerator->givePermissionTo($permission);
                }
