    ...
    public function run()
    {
        ...
        $email_templates = [
            ...
            [
                ...
                'message' => "<div style='box-sizing:border-box;font-family:Helvetica,Arial,sans-serif; font-size:16px; text-align:center; background-color:#edf2f7; color:#000; margin:0;padding:20px ;width:100%'><div style='color:#000; margin-bottom: 20px;'><strong>$appName</strong></div><div style='background:#fff; background-color:#fff; color:#718096; font-family:Helvetica,Arial,sans-serif; font-size:16px; text-align:left; max-width:600px; margin: 0 auto 20px; border: 1px solid #e5e4e6; border-radius: 10px; padding: 20px;'><p>Hello {user_name},</p><p>The job <strong>{job_title}</strong> at <strong>{company_name}</strong> has been edited and is waiting for your approval.</p><p>Please log in to the admin dashboard to review and approve the changes.</p><p>Best Regards<br><strong>$appName</strong></p></div><small>© ".date('Y')." $appName. All rights reserved.</small></div>",
            ],
            [
