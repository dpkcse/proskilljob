...
class JobFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'profession_id' => JobRole::inRandomOrder()->value('id'),
            ...
            'job_start' => $this->faker->dateTimeBetween('now', '+3 days'),
            'job_end' => $this->faker->dateTimeBetween('+4 days', '+30 days'),
        ];
    }

    public function getDescription($title, $company, $job_type, $min_salary, $max_salary)
    {
        $salary = $min_salary.' - '.$max_salary.' '.currentCurrencyCode();
