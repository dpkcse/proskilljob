...
Route::controller(WebsiteController::class)->name('website.')->group(function () {
    ...
    Route::get('/career-resources', 'careerResources')->name('career.resources');
    Route::get('/career-advice', 'careerResourcePage')->defaults('slug', 'career-advice')->name('career.advice');
    Route::get('/interview-tips', 'careerResourcePage')->defaults('slug', 'interview-tips')->name('interview.tips');
    Route::get('/resume-writing-tips', 'careerResourcePage')->defaults('slug', 'resume-writing-tips')->name('resume.writing.tips');
    Route::get('/cover-letter', 'careerResourcePage')->defaults('slug', 'cover-letter')->name('cover.letter');
    Route::get('/education-guide', 'careerResourcePage')->defaults('slug', 'education-guide')->name('education.guide');
    Route::get('/career-resources/{slug}', 'careerResourcePage')->name('career.resource');
...
Route::middleware('auth:user', 'verified')->group(function () {
    ...
    Route::controller(CandidateController::class)->prefix('candidate')->middleware('candidate')->name('candidate.')->group(function () {
        ...
        Route::post('/references', 'referenceStore')->name('references.store');
        Route::post('/references/update', 'referenceUpdate')->name('references.update');
        Route::delete('/references/{reference}', 'referenceDelete')->name('references.destroy');
