...
class WebsiteController extends Controller
{
            ...
            $candidate = User::where('username', $request->username)
                ->with([
                    ...
                    'candidate' => function ($query) {
                        $query->with('experiences', 'educations', 'experience', 'coverLetter', 'education', 'profession', 'languages:id,name', 'skills', 'socialInfo', 'professionalReferences');
                    },
                ])
                ->firstOrFail();

            $candidate->candidate->birth_date = $candidate->candidate->birth_date
                ? Carbon::parse($candidate->candidate->birth_date)->format('Y-m-d')
                : null;
    ...
    public function careerResourcePage(string $slug)
    {
        $pages = [
            'career-advice' => [
                'title' => 'Career Advice',
                'subtitle' => 'Practical guidance to plan your career growth with confidence.',
                'description' => 'Learn how to set strategic goals, build your professional network, and position yourself for long-term success.',
                'image' => 'frontend/assets/images/image-01.jpeg',
                'highlights' => [
                    ['icon' => 'ph-target', 'title' => 'Clear Career Goals', 'text' => 'Define measurable short and long-term goals aligned with your strengths.'],
                    ['icon' => 'ph-users-three', 'title' => 'Smart Networking', 'text' => 'Build meaningful connections with mentors and industry professionals.'],
                    ['icon' => 'ph-trend-up', 'title' => 'Growth Mindset', 'text' => 'Continuously improve skills to stay relevant in a changing job market.'],
                ],
                'tips' => ['Create a monthly career roadmap and review progress regularly.', 'Showcase achievements with real numbers in your profile and CV.', 'Follow industry trends and adapt your learning plan.'],
            ],
            'interview-tips' => [
                'title' => 'Interview Tips', 'subtitle' => 'Master interviews with better preparation and confident delivery.',
                'description' => 'From research to follow-up, improve every stage of your interview process with practical techniques.',
                'image' => 'frontend/assets/images/image-02.jpeg',
                'highlights' => [
                    ['icon' => 'ph-magnifying-glass', 'title' => 'Research First', 'text' => 'Understand company values, products, and role expectations before the interview.'],
                    ['icon' => 'ph-chats-circle', 'title' => 'Strong Storytelling', 'text' => 'Use STAR method to explain impact with clear context and results.'],
                    ['icon' => 'ph-handshake', 'title' => 'Professional Follow-up', 'text' => 'Send a concise thank-you note within 24 hours.'],
                ],
                'tips' => ['Practice role-specific questions with a friend.', 'Prepare thoughtful questions for the interviewer.', 'Maintain clear structure in every answer.'],
            ],
            'resume-writing-tips' => [
                'title' => 'Resume Writing Tips', 'subtitle' => 'Build a recruiter-friendly resume that highlights measurable results.',
                'description' => 'Make your resume easy to scan, ATS-friendly, and tailored for each role you apply to.',
                'image' => 'frontend/assets/images/image-03.jpeg',
                'highlights' => [
                    ['icon' => 'ph-file-text', 'title' => 'ATS Optimized', 'text' => 'Use relevant keywords naturally based on job descriptions.'],
                    ['icon' => 'ph-chart-bar', 'title' => 'Impact Driven', 'text' => 'Turn duties into achievements with metrics and outcomes.'],
                    ['icon' => 'ph-layout', 'title' => 'Clean Format', 'text' => 'Keep sections structured, concise, and easy to scan quickly.'],
                ],
                'tips' => ['Keep your summary focused on value.', 'Use bullet points instead of long paragraphs.', 'Update your resume for each job application.'],
            ],
            'cover-letter' => [
                'title' => 'Cover Letter', 'subtitle' => 'Write a compelling narrative that connects your skills to employer needs.',
                'description' => 'A strong cover letter helps recruiters understand your motivation and fit beyond your resume.',
                'image' => 'frontend/assets/images/image-04.jpeg',
                'highlights' => [
                    ['icon' => 'ph-envelope-open', 'title' => 'Personalized Opening', 'text' => 'Start with a role-specific statement and clear intent.'],
                    ['icon' => 'ph-briefcase', 'title' => 'Relevant Experience', 'text' => 'Link your top achievements directly to job requirements.'],
                    ['icon' => 'ph-check-circle', 'title' => 'Confident Closing', 'text' => 'End with a clear call to action and professional tone.'],
                ],
                'tips' => ['Keep it concise and targeted.', 'Show alignment with company mission.', 'Proofread carefully before sending.'],
            ],
            'education-guide' => [
                'title' => 'Education Guide', 'subtitle' => 'Choose learning paths that improve skills and employability.',
                'description' => 'Compare courses and certifications based on career outcomes, practical projects, and mentorship quality.',
                'image' => 'frontend/assets/images/image-06.jpeg',
                'highlights' => [
                    ['icon' => 'ph-graduation-cap', 'title' => 'Career-focused Learning', 'text' => 'Select programs that match your target role and industry demand.'],
                    ['icon' => 'ph-code', 'title' => 'Project-based Practice', 'text' => 'Build portfolio-ready projects while learning core concepts.'],
                    ['icon' => 'ph-certificate', 'title' => 'Valuable Credentials', 'text' => 'Prioritize recognized certifications with practical outcomes.'],
                ],
                'tips' => ['Set a weekly learning schedule.', 'Document projects in a public portfolio.', 'Track skill progress using milestones.'],
            ],
        ];
        ...
        $resourceLinks = [
            ['title' => 'Career Advice', 'url' => route('website.career.resource', ['slug' => 'career-advice'])],
            ['title' => 'Interview Tips', 'url' => route('website.career.resource', ['slug' => 'interview-tips'])],
            ['title' => 'Resume Writing Tips', 'url' => route('website.career.resource', ['slug' => 'resume-writing-tips'])],
            ['title' => 'Cover Letter', 'url' => route('website.career.resource', ['slug' => 'cover-letter'])],
            ['title' => 'Education Guide', 'url' => route('website.career.resource', ['slug' => 'education-guide'])],
            ['title' => 'Blog', 'url' => route('website.posts')],
        ];

        return view('frontend.pages.career-resource', compact('resourceLinks') + [
            'resource' => $pages[$slug],
        ]);
    }
