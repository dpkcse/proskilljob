    ...
    public function boot()
    {
        ...
        if (! app()->runningInConsole()) {
            ...
            if (moduleActive('CandidatePlan')) {
                $hasActiveCandidatePlan = Cache::remember('hasActiveCandidatePlan', $expirationTime, function () {
                    return \Modules\CandidatePlan\Entities\CandidatePlan::where('is_active', 1)->exists();
                });
                view()->share('hasActiveCandidatePlan', $hasActiveCandidatePlan);
            }
