                                                    ...
                                                    <div class="tab-pane fade " id="profile" role="tabpanel"
                                                        ...
                                                        <div class="tw-py-6">
                                                            ...
                                                            <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4 tw-mb-6">
                                                                <div class="tw-bg-[#F8F8F8] tw-rounded tw-p-3">
                                                                    <h5 class="tw-text-sm tw-font-semibold tw-text-[#18191C]">{{ __('father_name') }}</h5>
                                                                    <p class="tw-text-sm tw-text-[#5E6670] tw-mb-0">
                                                                        {{ candidate.father_name || __('not_available') }}
                                                                    </p>
                                                                </div>
                                                                <div class="tw-bg-[#F8F8F8] tw-rounded tw-p-3">
                                                                    <h5 class="tw-text-sm tw-font-semibold tw-text-[#18191C]">{{ __('mother_name') }}</h5>
                                                                    <p class="tw-text-sm tw-text-[#5E6670] tw-mb-0">
                                                                        {{ candidate.mother_name || __('not_available') }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <h4
                                                            ...
                                                            <h4
                                                                class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C] tw-mb-4">
                                                                {{ __('reference') }}</h4>
                                                            <div v-if="candidate.professional_references && candidate.professional_references.length"
                                                                class="table-responsive tw-mb-4">
                                                                <table class="table table-sm table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                        <tr v-for="reference in candidate.professional_references" :key="reference.id">
                                                            ...
                                                            <p v-else class="tw-text-sm tw-text-[#5E6670]">
                                                                {{ __('not_available') }}
                                                            </p>
