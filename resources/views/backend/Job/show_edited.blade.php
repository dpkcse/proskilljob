            ...
            <div class="card-header">
                ...
                <div class="float-right d-flex align-items-center justify-content-center">
                    <form action="{{ route('admin.job.edited.approved', $job->slug) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <button type="submit" onclick="return confirm('{{ __('are_you_sure_you_want_to_delete_this_item') }}');"
                        ...
                        <div class="pt-1 pb-4">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-6">
                                    ...
                                    <input id="job_start" class="form-control" value="{{ $job->job_start ? date('Y-m-d', strtotime($job->job_start)) : '' }}" disabled>
                                    <label for="job_end" class="mt-2">
                                        {{ __('job_end') }}
                                    </label>
                                    <input id="job_end" class="form-control" value="{{ $job->job_end ? date('Y-m-d', strtotime($job->job_end)) : '' }}" disabled>
                                    <label for="deadline" class="mt-2">
                                        {{ __('deadline') }}
                                    </label>
                        ...
                        <div class="pt-1 pb-4">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-6">
                                    ...
                                    <input id="job_start" class="form-control" value="{{ $parent_job->job_start ? date('Y-m-d', strtotime($parent_job->job_start)) : '' }}" disabled>
                                    <label for="job_end" class="mt-2">
                                        {{ __('job_end') }}
                                    </label>
                                    <input id="job_end" class="form-control" value="{{ $parent_job->job_end ? date('Y-m-d', strtotime($parent_job->job_end)) : '' }}" disabled>
                                    <label for="deadline" class="mt-2">
                                        {{ __('deadline') }}
                                    </label>
                                    <input id="deadline" class="form-control"
