                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12 col-md-6">
                                            <x-forms.label name="gender" for="gender" :required="false" />
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <x-forms.label name="min_age" for="min_age" :required="false" />
                                            <input id="min_age" type="number" min="0" max="100" name="min_age"
                                                class="form-control @error('min_age') is-invalid @enderror"
                                                value="{{ old('min_age', $job->min_age) }}" placeholder="{{ __('min_age') }}">
                                            @error('min_age')
                                                <span class="invalid-feedback" role="alert"><strong>{{ __($message) }}</strong></span>
                                            @enderror
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <x-forms.label name="max_age" for="max_age" :required="false" />
                                            <input id="max_age" type="number" min="0" max="100" name="max_age"
                                                class="form-control @error('max_age') is-invalid @enderror"
                                                value="{{ old('max_age', $job->max_age) }}" placeholder="{{ __('max_age') }}">
                                            @error('max_age')
                                                <span class="invalid-feedback" role="alert"><strong>{{ __($message) }}</strong></span>
                                            @enderror
                                        </div>
                        ...
                        <div class="section pt-3" id="attributes">
                            <div class="card mb-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-6">
                                            <x-forms.label name="required_experience_type_area" for="experience_area" :required="false" />
                                            <input type="text" name="experience_area" id="experience_area"
                                                value="{{ old('experience_area', $job->experience_area) }}" class="form-control @error('experience_area') is-invalid @enderror">
                                        </div>
                                        <div class="col-md-6">
                                            <x-forms.label name="business_area_industry" for="business_area" :required="false" />
                                            <select name="business_area" id="business_area" class="form-control select2bs4 @error('business_area') is-invalid @enderror">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <x-forms.label name="experience_description" for="experience_description" :required="false" />
                                            <textarea name="experience_description" id="experience_description" rows="3"
                                                class="form-control @error('experience_description') is-invalid @enderror">{{ old('experience_description', $job->experience_description) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-8">
                                            <x-forms.label name="required_degrees" for="required_degrees" :required="false" />
                                            @php $selectedDegrees = old('required_degrees', json_decode($job->required_degrees ?? '[]', true) ?: []); @endphp
                                            <select name="required_degrees[]" id="required_degrees" multiple class="form-control select2tags @error('required_degrees') is-invalid @enderror">
                                        ...
                                        <div class="col-md-4">
                                            <x-forms.label name="other_degree" for="required_degrees_other" :required="false" />
                                            <input type="text" name="required_degrees_other" id="required_degrees_other" value="{{ old('required_degrees_other', $job->required_degrees_other) }}"
                                                class="form-control @error('required_degrees_other') is-invalid @enderror" placeholder="{{ __('please_specify') }}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <x-forms.label name="preferred_educational_institution" for="preferred_institutions" :required="false" />
                                            @php $preferredInstitutions = old('preferred_institutions', json_decode($job->preferred_institutions ?? '[]', true) ?: []); @endphp
                                            <select name="preferred_institutions[]" id="preferred_institutions" multiple class="form-control select2tags @error('preferred_institutions') is-invalid @enderror">
