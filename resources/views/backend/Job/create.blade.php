                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            ...
                                            <input id="min_age" type="number" min="0" max="100" name="min_age"
                                                ...
                                                value="{{ old('min_age') }}" placeholder="{{ __('min_age') }}">
                                            @error('min_age')
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            ...
                                            <input id="max_age" type="number" min="0" max="100" name="max_age"
                                                ...
                                                value="{{ old('max_age') }}" placeholder="{{ __('max_age') }}">
                                            @error('max_age')
                                                <span class="invalid-feedback" role="alert"><strong>{{ __($message) }}</strong></span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="experience_area" id="experience_area"
                                                value="{{ old('experience_area') }}" class="form-control @error('experience_area') is-invalid @enderror">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select name="business_area" id="business_area" class="form-control select2bs4 @error('business_area') is-invalid @enderror">
                                                ...
                                                @foreach (['sales','marketing','it','education','healthcare','garments_textile','finance_banking','customer_support','others'] as $ba)
                                                    <option value="{{ $ba }}" @selected(old('business_area')===$ba)>{{ __($ba) }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="experience_description" id="experience_description" rows="3"
                                                class="form-control @error('experience_description') is-invalid @enderror">{{ old('experience_description') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="required_degrees_other" id="required_degrees_other" value="{{ old('required_degrees_other') }}"
