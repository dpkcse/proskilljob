                ...
                <form id="formSubmit" action="{{ route('job.index') }}" method="GET" onchange="this.submit();">
                    <div class="card-body border-bottom row">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-6 col-12">
                            ...
                            <select name="profession_id" class="form-control select2bs4">
                                <option value="">
                                    {{ __('all') }}
                                </option>
                                @foreach ($professions as $profession)
                                    <option {{ request('profession_id') == $profession->id ? 'selected' : '' }} value="{{ $profession->id }}">
                                        {{ $profession->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <table class="ll-table table table-hover text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="10%">{{ __('category') }}/{{ __('role') }}/{{ __('profession') }}</th>
                                        <th width="10%">{{ __('salary') }}</th>
                                        <th width="10%">{{ __('job_start') }}</th>
                                        <th width="10%">{{ __('job_end') }}</th>
                                        ...
                                        @foreach ($jobs as $job)
                                            <tr>
                                                    ...
                                                    <div class="category">
                                                        ...
                                                        <div>
                                                            @if ($job->salary_mode == 'range')
                                                                <h3 class='bold'>{{ getFormatttedRangeSalary($job) }}</h3>
                                                            @else
                                                ...
                                                <td class="text-center" tabindex="0">
                                                    {{ $job->job_start ? date('j F, Y', strtotime($job->job_start)) : '-' }}
                                                </td>
                                                <td class="text-center" tabindex="0">
                                                    {{ $job->job_end ? date('j F, Y', strtotime($job->job_end)) : '-' }}
                                                </td>
                                                            ...
                                                            @if ($job->status == 'active' || $job->status == 'pending')
                                                                <form
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <label class="custom-control-label"
                                                                            for="status_input_publish_{{ $job->id }}">{{ __('published') }}</label>
                                                                    </div>
                                                                </form>
                                                            @endif
