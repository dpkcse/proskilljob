...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('monthly_job_posts') }}</span>
                    <span class="info-box-number">{{ $data['monthly_job_posts'] }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('active_users') }}</span>
                    <span class="info-box-number">{{ $data['active_users'] }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('hiring_success_rate') }}</span>
                    <span class="info-box-number">{{ $data['hiring_success_rate'] }}%</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('admin_decision_alerts') }}</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        @foreach ($decisionAlerts as $alert)
                            <div class="col-md-6 col-xl-3 mb-3">
                                <div class="small-box bg-{{ $alert['type'] }}">
                                    <div class="inner">
                                        <h3>{{ $alert['value'] }}</h3>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('notification_system_structure') }}</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        @foreach ($notificationModules as $module)
                            <div class="col-md-6 col-xl-4 mb-3">
                                @php
                                    $priority = strtolower($module['priority']);
                                    ...
                                    $priorityIcon = match ($priority) {
                                        'critical' => 'fas fa-radiation-alt',
                                        'high' => 'fas fa-exclamation-triangle',
                                        'medium' => 'fas fa-chart-line',
                                        default => 'fas fa-info-circle',
                                    };
                                @endphp
                                <div class="card h-100 shadow-sm border-0">
                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 text-uppercase">{{ __($module['key']) }}</h6>
                                        <span class="badge badge-{{ $priorityClass }}">
                                            <i class="{{ $priorityIcon }} mr-1"></i>{{ ucfirst($module['priority']) }}
                                        </span>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="text-muted small">{{ __('channel') }}</span>
                                            <span class="font-weight-semibold text-dark">{{ ucfirst($module['channel']) }}</span>
                                        </div>
                                        <div class="progress mb-3" style="height: 6px;">
                                            <div class="progress-bar bg-{{ $priorityClass }}" role="progressbar" style="width: {{ $priority === 'critical' ? 100 : ($priority === 'high' ? 80 : ($priority === 'medium' ? 60 : 40)) }}%"></div>
                                        </div>
                                    ...
                                    <div class="card-footer bg-white border-top-0 text-muted small">
                                        Total: {{ count($module['items']) }} items
                                    </div>
                                </div>
                            </div>
                        @endforeach
