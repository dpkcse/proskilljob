            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control @error('footer_linkedin_link') is-invalid @enderror p-2"
                            name="footer_linkedin_link" value="{{ $cms_setting->footer_linkedin_link }}">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control @error('footer_pinterest_link') is-invalid @enderror p-2"
                            name="footer_pinterest_link" value="{{ $cms_setting->footer_pinterest_link }}">
                        @error('footer_pinterest_link')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control @error('footer_tiktok_link') is-invalid @enderror p-2"
                            name="footer_tiktok_link" value="{{ $cms_setting->footer_tiktok_link }}">
                        @error('footer_tiktok_link')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control @error('footer_whatsapp_link') is-invalid @enderror p-2"
                            name="footer_whatsapp_link" value="{{ $cms_setting->footer_whatsapp_link }}">
                        @error('footer_whatsapp_link')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                </div>
