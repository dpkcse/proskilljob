                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    ...
                                                    <input name="about_brand_logo" type="file" class="form-control dropify"
                                                        data-default-file="{{ asset($cms_setting->about_brand_logo) }}"
                                                        data-allowed-file-extensions='["jpg", "jpeg","png"]'>
                                                        <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">{{ __('recommended_image_size') }}: 198x45</p>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <input name="candidate_image" type="file" class="form-control dropify"
                                                    ...
                                                    <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">{{ __('recommended_image_size') }}: 1296x580</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
