            ...
            <div class="card">
                <div class="card-header ">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title">
                            {{ __('carrerjet_api') }}
                            (<small><a target="_blank" href="https://www.careerjet.com.bd/partners/?ak=90be9ef4225c017181e4804a187f1a60">
            ...
            <div class="card">
                <div class="card-header ">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title">
                            {{ __('indeed_api') }}
                            (<small><a target="_blank" href="https://indianaffiliateprograms.in/affiliate-programs/indeed/">
                                Become an affiliate partner
                            </a></small>)
                        </h3>
                    </div>
