...
@section('website-settings')
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-12">
                    ...
                    <form action="{{ route('settings.system.update') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="timezone"
                                        ...
                                        @foreach ($timezones as $timezone)
                                            <option {{ config('templatecookie.timezone') == $timezone->value ? 'selected' : '' }}
                                ...
                                <div class="form-group">
                                    <x-forms.label class="mt-1" name="help_widget" :required="true" />
                                    <div>
                                        <input type="hidden" name="help_widget" value="0" />
                                        <input type="checkbox" id="help_widget"
                                            {{ $setting->help_widget ? 'checked' : '' }} name="help_widget"
                                            data-on-color="success" data-bootstrap-switch
                                            data-on-text="{{ __('on') }}" data-off-color="default"
                                            data-off-text="{{ __('off') }}" data-size="small" value="1">
                                        <x-forms.error name="help_widget" />
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    {{ __('Candidate configuration') }}
                </div>
                <div class="card-body">
                    <form action="{{ route('settings.candidate.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            <x-forms.label name="candidate_account_auto_activation" class="col-sm-6" :required="true"/>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <x-forms.label name="candidate_gender_active" class="col-sm-6" :required="true"/>
                            <div class="col-sm-6">
                                <input type="hidden" name="candidate_gender_active" value="0"/>
                                <input type="checkbox" id="candidate_gender_active"
                                       {{ $setting->candidate_gender_active ? 'checked' : '' }}
                                       name="candidate_gender_active" data-bootstrap-switch data-on-color="success"
                                       data-on-text="{{ __('on') }}" data-off-color="default"
                                       data-off-text="{{ __('off') }}" data-size="small" value="1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <x-forms.label name="candidate_birth_date_active" class="col-sm-6" :required="true"/>
                            <div class="col-sm-6">
                                <input type="hidden" name="candidate_birth_date_active" value="0"/>
                                <input type="checkbox" id="candidate_birth_date_active"
                                       {{ $setting->candidate_birth_date_active ? 'checked' : '' }}
                                       name="candidate_birth_date_active" data-bootstrap-switch data-on-color="success"
                                       data-on-text="{{ __('on') }}" data-off-color="default"
                                       data-off-text="{{ __('off') }}" data-size="small" value="1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <x-forms.label name="candidate_marital_status_active" class="col-sm-6" :required="true"/>
                            <div class="col-sm-6">
                                <input type="hidden" name="candidate_marital_status_active" value="0"/>
                                <input type="checkbox" id="candidate_marital_status_active"
                                       {{ $setting->candidate_marital_status_active ? 'checked' : '' }}
                                       name="candidate_marital_status_active" data-bootstrap-switch
