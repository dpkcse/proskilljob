            ...
            <div class="row">
                <div class="col-12">
                    <div class="tw-flex tw-flex-wrap tw-items-center tw-gap-2 tw-mb-6 tw-mx-1.5 sm:tw-mx-0">
                        <p class="tw-text-[#767F8C] tw-text-sm tw-mb-0">{{ __('popular_profession') }}:</p>
                        ...
                        <div class="tw-flex tw-gap-2 tw-items-center">
                            @if (request('keyword') ||
                                ...
                                <div class="d-flex w-100-p">
                                    ...
                                    @endif
                                    @if (setting('candidate_gender_active') && Request::get('gender') && Request::get('gender') != 'all')
                                        <div class="rt-mr-2 icon-badge">
...
@section('frontend_scripts')
    ...
    <script>
        function professionFilter(profession) {
            // Set the profession name directly in the select dropdown
            var professionSelect = $('.candidate-profession');
            professionSelect.val(profession);
            
            $('#candidate_search_form').submit();
        }

        // Filter function for form submission
        function Filter() {
            $('#candidate_search_form').submit();
        }
