                    ...
                    <div class="form-group tw-mb-6">
                        ...
                        <div class="cv-image-upload-wrap">
                            <input name="resume_file" onchange="resumeManageReadURL(this, 'add');" id="resume_add_input"
                                class="resume-file-upload-input" type="file" accept="application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document"
                                id="resume_add_input" />
                            <div class="drag-text">
                                <x-svg.upload-icon />
                        ...
                        <div class="resume-file-upload-content none">
                            <div class="wrap">
                                ...
                                <p>
                                    ...
                                    <span class="resume_selected_file_type">.pdf,.doc,.docx</span>
                                </p>
