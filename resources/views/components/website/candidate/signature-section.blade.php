{{-- Signature upload --}}
<x-forms.label name="signature"
    class="pointer body-font-4 d-block text-gray-900 rt-mb-8" />

<div id="signature-uploadMode"
     class="signature-upload {{ $candidate->signature ? 'd-none' : '' }}">
    <div class="profile-image-upload-wrap">
        <input name="signature"
               class="profile-file-upload-input"
               type="file"
    ...
    <div class="profile-file-upload-content">
        ...
        <div class="image-title-wrap">
            <button type="button" class="signature-remove-image">
...
<div id="signature-oldMode"
     class="signature-upload {{ $candidate->signature ? '' : 'd-none' }}">
    <div class="profile-file-upload-content2">
        <img class="profile-file-upload-image"
             src="{{ asset($candidate->signature) }}"
             alt="your signature" />
        <div onclick="UploadMode('signature')" class="image-title-wrap">
            <button type="button" class="signature-remove-image">
                <svg width="20" height="20" viewBox="0 0 20 20"
                     fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.875 4.375L3.125 4.37501" stroke="#E05151"
...
<p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2">
    {{ __('image_size') }}: 300X80
</p>
