                        ...
                        <div class="subscribe-inputbox-1 row smallgap">
                            <div class="col-md-8">
                                <div class="fromGroup has-icon2 group">
                                    <input required type="email" name="email" placeholder="{{ __('email_address') }}"
                                        class="form-control @error('email') is-invalid @enderror" style="color: white; background-color: transparent;">
