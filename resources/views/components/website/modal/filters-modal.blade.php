@props(['jobTypes', 'categories', 'professions', 'maxSalary', 'currentCurrency'])
    ...
    <div
        ...
        <div class="modal-content tw-rounded-none tw-relative tw-min-h-screen tw-max-h-screen">
            <div class="tw-h-screen tw-overflow-x-hidden tw-overflow-y-auto tw-pb-24">
                ...
                <div class="tw-px-5">
                    <label for="profession" class="tw-block tw-text-sm tw-text-[#0A65CC] tw-mb-2 tw-font-medium">{{ __('profession') }}</label>
...
@push('frontend_scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#profession').select2({
                width: '100%',
                placeholder: "{{ __('choose_profession') }}",
                allowClear: true
            });
        });
    </script>
