    ...
    <div class="modal-dialog  modal-wrapper">
        <div class="modal-content">
            <div class="modal-body">
                    ...
                    <div class="col-md-4 d-md-flex align-items-center justify-content-md-end">
                        <div class="d-flex gap-3 flex-column flex-md-row">
                            <button
                                ...
                                type="button" data-bs-toggle="modal" data-bs-target="#messageModal"
                            ...
                            <button id="downloadCVButton"
                                ...
                                <svg  width="28" height="28" viewBox="0 0 25 25"  xmlns="http://www.w3.org/2000/svg" fill="none" stroke-width="1.5" stroke="currentColor" >
                                ...
                                <button id="removeBookmakCandidate"
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#fff" stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </button>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <ul class="nav nav-tabs tw-gap-x-6 !tw-border-b !tw-border-[#E3E5E6]" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="ll-nav-link nav-link" id="profile-tab" data-bs-toggle="tab"
                                    ata-bs-target="#profile" type="button" role="tab" aria-controls="profile"
                                    ria-selected="false"> {{ __('about_me') }} </button>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="profile" role="tabpanel"
                                ...
                                <div class="tw-py-6">
                                    <h4 class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C]"> {{
                                        __('biography') }} </h4>
                                    <p class="tw-text-base tw-text-[#5E6670]" id="candidate-bio"> </p>
                                    <h4 class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C] tw-mb-4">
                                        {{ __('experience') }} </h4>
            ...
            <div class="chat-top tw-rounded-tl-xl tw-rounded-tr-xl tw-p-6 tw-bg-[#F1F2F4]">
                ...
                <div class="tw-flex tw-gap-3 tw-mb-3 tw-items-center">
                    <img class="tw-w-[48px] tw-h-[48px] tw-rounded-full tw-object-cover"
                        src="{{ asset('frontend') }}/assets/images/all-img/candidate-profile.png" alt="candidate img"
                        id="message_candidate_image">
                    <div>
                        <h3 class="tw-mt-0 tw-mb-1 tw-font-medium tw-text-sm tw-text-[#18191C]"
                            id="message_candidate_name">
                            N/A
                        </h3>
            ...
            <div class="chat-bottom tw-p-6 tw-bg-white tw-rounded-bl-xl tw-rounded-br-xl">
                <form action="{{ route('company.message.candidate') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea required id="chat" placeholder="{{ __('write_your_message') }}" rows="5"
                    ...
                    <div class="tw-mt-6 tw-flex tw-justify-between tw-items-center">
                        ...
                        <button type="button"
                            class="btn tw-py-[11px] tw-px-[23px] tw-text-base tw-capitalize tw-font-semibold tw-text-[#474C54] tw-border tw-border-[#E4E5E8]">{{
                            __('cancel') }}</button>
                        <button type="submit"
