@props(['countries', 'categories', 'professions', 'jobRoles', 'min_salary', 'max_salary', 'experiences', 'educations', 'jobTypes', 'currentCurrency'])
...
<x-website.modal.filters-modal :job-types="$jobTypes" :categories="$categories" :professions="$professions" :max-salary="$maxSalary" :currentCurrency="$currentCurrency" />
