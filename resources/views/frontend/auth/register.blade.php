            ...
            <div class="container">
                <div class="row ">
                    <div class="col-xl-5 col-lg-6 col-md-12 tw-bg-white tw-relative tw-z-50">
                        <div class="auth-box2">
                            @if (!$smtp_settings_complete)
                                <div class="alert alert-warning" role="alert">
                                    {{ __('registration_is_currently_disabled_smtp_settings_are_not_properly_configured') }}
                                </div>
                            @endif
                            <form id="formId" action="{{ route('register') }}" method="POST" class="rt-form" @if(!$smtp_settings_complete) onsubmit="return false;" @endif>
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                ...
                                <button id="submitButton" type="submit" class="btn btn-primary d-block rt-mb-15" @if(!$smtp_settings_complete) disabled @endif>
