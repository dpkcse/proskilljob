                            ...
                            <div class="rt-single-icon-box icb-clmn-lg tw-reltaive">
                                ...
                                <div class="iconbox-content !tw-m-0">
                                    ...
                                    <div class="bottom-link mt-1">
                                        ...
                                        @else
                                        <span class="body-font-4 text-primary-500 login_required">{{
                                            __('view_resume')
                                            }}
                                            <x-svg.arrow-right-icon />
                                        </span>
                                ...
                                <div
                                    ...
                                    <div data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="{{ __('you_have_seen_the_cv_on_after_the_view_count_will_be_reset', [
                                            'view_date' => $candidate->already_views && $candidate->already_views[0] ? $candidate->already_views[0]->view_date_time : '-',
                                            'after_date' => $candidate->already_views && $candidate->already_views[0] ? $candidate->already_views[0]->expired_date : '-'
                                        ]) }}"
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#downloadCVButton').on('click', function() {
                        ...
                        var downloadUrl = "/candidates/download/cv/" + resumeId; // Construct the download URL
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                a.href = url;
                                a.download = 'candidate_resume_' + resumeId + '.pdf'; // Customize the filename if needed
                    ...
                    @endif
                    data.candidate.country ? $('#candidate_nationality').html(data.candidate.country) : ''
                    ...
                    data.contact_info && data.contact_info.secondary_phone ? $('#candidate_seconday_phone')
                        .html(data.contact_info
                            .secondary_phone) : ''
                    data && data.email ? $('#contact_info_email').html(data
                        .email) : ''
