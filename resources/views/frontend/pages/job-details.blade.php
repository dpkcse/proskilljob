                    ...
                    <div class="tw-px-8 tw-pb-6 tw-pt-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 rt-mb-32">
                                <div class="single-jSidebarWidget">
                                    <div class="icon-thumb">
                                        <i class="ph-gender-intersex f-size-30 text-primary-500"></i>
                                    </div>
                                    <div class="iconbox-content">
                                        <div class="f-size-12 text-gray-500 uppercase text-uppercase rt-mb-6">
                                            {{ __('gender') }}</div>
                                        <span class="d-block f-size-14 ft-wt-5 text-gray-900">
                                            {{ $job->gender ? __(strtolower($job->gender)) : __('any') }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            @endif
                            @if ($job->experience_area || $job->business_area || $job->experience_description)
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 rt-mb-32">
                                <div class="single-jSidebarWidget">
                                    <div class="iconbox-content">
                                        <div class="f-size-12 text-gray-500 uppercase text-uppercase rt-mb-6">{{ __('experience_requirement') }}</div>
                                        @if ($job->experience_area)
                                            <div class="f-size-14">{{ __('required_experience_type_area') }}: {{ $job->experience_area }}</div>
                                        @endif
                                        @if ($job->business_area || $job->business_area_other)
                                            <div class="f-size-14">{{ __('business_area_industry') }}: {{ $job->business_area === 'others' ? $job->business_area_other : __($job->business_area) }}</div>
                                        @endif
                                        @if ($job->experience_description)
                                            <div class="f-size-14">{{ __('experience_description') }}: {{ $job->experience_description }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            @endif
                            @php $requiredDegrees = json_decode($job->required_degrees ?? '[]', true) ?: []; @endphp
                            @if (count($requiredDegrees) || $job->required_degrees_other)
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 rt-mb-32">
                                <div class="single-jSidebarWidget">
                                    <div class="iconbox-content">
                                        <div class="f-size-12 text-gray-500 uppercase text-uppercase rt-mb-6">{{ __('educational_requirement') }}</div>
                                        <div class="f-size-14">
                                            {{ collect($requiredDegrees)->map(fn($d) => __($d))->implode(', ') }}
                                            @if ($job->required_degrees_other)
                                                {{ count($requiredDegrees) ? ', ' : '' }}{{ $job->required_degrees_other }}
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            @endif
                            @php $preferredInstitutions = json_decode($job->preferred_institutions ?? '[]', true) ?: []; @endphp
                            @if (count($preferredInstitutions))
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 rt-mb-32">
                                <div class="single-jSidebarWidget">
                                    <div class="iconbox-content">
                                        <div class="f-size-12 text-gray-500 uppercase text-uppercase rt-mb-6">{{ __('preferred_educational_institution') }}</div>
                                        <div class="f-size-14">{{ collect($preferredInstitutions)->implode(', ') }}</div>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 rt-mb-32">
                                <div class="single-jSidebarWidget">
                                    <div class="icon-thumb rt-mr-17">
                                        <i class="ph-hourglass-medium f-size-30 text-primary-500"></i>
                                    </div>
                                    <div class="iconbox-content">
                                        <div class="f-size-12 text-gray-500 uppercase text-uppercase rt-mb-6">
                                            {{ __('age_limit') }}</div>
