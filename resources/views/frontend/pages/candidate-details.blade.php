                ...
                <div class="col-lg-5">
                    <div class="cadidate-details-sidebar">
                        <div class="sidebar-widget">
                            <div class="row">
                                @if (setting('candidate_birth_date_active') && $candidate?->candidate?->birth_date)
                                    <div class="col-sm-4">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                ...
                                @endif
                                @if (setting('candidate_marital_status_active') && $candidate?->candidate?->marital_status)
                                    <div class="col-sm-4">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <x-svg.board-icon />
                                ...
                                @endif
                                @if (setting('candidate_gender_active') && $candidate?->candidate?->gender)
                                    <div class="col-sm-4">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <x-svg.gender />
