            ...
            <div
                ...
                <div class="modal-content tw-rounded-none tw-relative tw-min-h-screen tw-max-h-screen">
                    <div class="tw-h-screen tw-overflow-x-hidden tw-overflow-y-auto tw-pb-24">
                        ...
                        <div class="tw-px-5">
                            <h2 class="tw-text-[#0A65CC] tw-text-sm tw-font-medium">{{ __('industry') }}</h2>
                        ...
                        <div class="tw-px-5">
                            <h2 class="tw-text-sm tw-text-[#0A65CC] tw-mt-4 tw-font-medium">{{ __('organization') }}</h2>
                            <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                                <input class="tw-scale-125" type="radio" id="organization_type" value=""
                                    name="organization_type">
                                <label for="organization_type" class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">
                                    {{ __('all_organization') }}
                                </label>
                            </div>
                            @foreach ($organization_types as $organization_type)
                        ...
                        <hr class="tw-bg-[#E4E5E8] tw-m-0">
                        <div class="tw-p-5">
                            <h2 class="tw-text-sm tw-text-[#0A65CC] tw-mb-4 tw-font-medium">{{ __('team_size') }}</h2>
                            <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                                <input type="radio" id="allTeam" value=" " class="tw-scale-125"
                                    name="team_size">
                                <label for="allTeam" class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ __('all_team_size') }}</label>
                            </div>
    ...
    @if ($map == 'google-map')
        <script>
            function initMap() {
                ...
                let country_code = '{{ appCountryCode() }}';
                if (country_code) {
                    var options = {
