                                ...
                                <a href="{{ socialMediaShareLinks(url()->current(), 'linkedin')}}">
                                    <button class="btn btn-outline-plain tw-px-2 tw-py-1.5 tw-text-sm hover-fb">
                                        <span class="f-size-18 text-primary-500">
                                            <x-svg.linkedin-icon width="1em" height="1em" />
                                        </span>
                                        <span class="text-primary-500">{{ __('linkedin') }}</span>
                                    </button>
                                </a>
                            </li>
                                    ...
                                    @if ($user->company->establishment_date)
                                        <div class="col-sm-6">
                                            <div class="icon-box">
                                                ...
                                                <h2 class="title">
                                                    {{ \Carbon\Carbon::parse($user->company->establishment_date)->format('d/m/Y') }}
                                                </h2>
                                            </div>
                                        </div>
                                    @endif
                            ...
                            <div class="card-body">
                                <div class="rt-single-icon-box">
                                    ...
                                    <div class="iconbox-content">
                                        ...
                                        <span class="loacton text-gray-700 d-inline-flex ">
                                ...
                                <div class="post-info">
                                    ...
                                    <div class="body-font-4 text-gray-600" id="pagination-container">
                                        ...
                                        <span class="info-tools has-dot">{{ getFormatttedRangeSalary($job) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
