...
<header class="header rt-fixed-top">
    ...
    <div class="n-header">
        ...
        <nav class="topbar-notice d-none d-md-block {{ $headerBgClass }}" role="region" aria-label="Site notice">
                    ...
                    <div class="n-header--bottom__right">
                        <div class="d-flex align-items-center ">
                            ...
                            <ul class="list-unstyled tw-flex tw-flex-wrap tw-gap-3 tw-items-center tw-justify-between">
                                <li>
                                    <a href="{{ route('login') }}" class="btn btn-job">{{ __('job_seekers') }}</a>
                                </li>
