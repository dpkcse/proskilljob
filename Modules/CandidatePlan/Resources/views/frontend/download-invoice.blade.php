        ...
        <div class="ll-invoice-in">
            ...
            <div class="ll-invoice-info">
                ...
                <div class="ll-invoice-info_right">
                    <div><span>Invoice No:</span> <b>#{{ $transaction->id }}</b></div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ currencyConversion($transaction->amount, 'USD') }} {{ currentCurrencyCode() }}</td>
                                <td>1</td>
                                <td class="text-right">{{ currencyConversion($transaction->amount, 'USD') }} {{ currentCurrencyCode() }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="ll-invoice-footer-table">
                    <div class="left-side">
                        ...
                        <p>
                            ...
                            Payment Status: {{ ucfirst($transaction->payment_status) }} <br>
