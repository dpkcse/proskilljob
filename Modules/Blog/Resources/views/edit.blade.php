...
@endsection
@section('content')
<form class="row mt-4" action="{{ route('module.blog.update', $post->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36">{{ __('edit') }} {{ __('post') }}</h3>
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($languages as $lang)
                                        <div class="custom-control custom-radio mr-3">
                                            <input class="custom-control-input" type="radio" id="lang_code_{{ $lang->id }}" name="locale" {{ $lang->code == $post->locale ? 'checked':'' }} value="{{ $lang->code }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="upload-btn-wrapper">
                                        <input type="file" class="form-control dropify"
                                            ...
                                            <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">{{ __('recommended_image_size') }}: 800x500</p>
                                    </div>
                                    @error('image')
